...
function App() {
    ...
    return (
        <div className="text-center min-h-screen flex justify-center items-start ">
            <div className="bg-gradient-to-r from-fuchsia-500 to-cyan-500 w-[95%]  lg:w-1/2 mt-20 min-h-[80vh] rounded-2xl">
                ...
                {items.length>0 && <button onClick={()=>clearAll()} className={items.length==0  ? "hidden":"bg-black text-white p-2 px-3 m-2 hover:rounded-xl  hover:bg-gradient-to-r from-red-500 to-red-900 font-bold mb-6 "}
                type="button">
                    Clear All
                </button>}
            </div>
